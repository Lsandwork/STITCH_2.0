...
const LESSONS: SeedLesson[] = [
  ...
  },
  {
    ...
    category: "Pattern Kit",
    description: "Sculpted bell dome amigurumi with flowing spiral tentacles.",
    content: "280 yds sport yarn, 3.25 mm hook. Dome shaping, 12 tentacles, optional hanging loop.",
    difficulty: "intermediate",
    duration_minutes: 300,
    sort_order: 20,
    illustration_url: "/assets/learn/jellyfish-amigurumi.jpg",
    is_published: true,
  },
  {
    ...
    category: "Pattern Kit",
    description: "34×38-inch chevron ripple blanket in six machine-washable colors.",
    content: "2,400 yds light worsted yarn, 5.0 mm hook. Flat ripple rows with picot border.",
    difficulty: "beginner",
    duration_minutes: 840,
    sort_order: 21,
    illustration_url: "/assets/learn/ripple-baby-blanket.jpg",
    is_published: true,
  },
  {
    ...
    category: "Pattern Kit",
    description: "Adult cotton bucket hat with structured crown and 3-inch brim.",
    content: "320 yds cotton DK yarn, 4.0 mm hook. Top-down crown, body, and flared brim.",
    difficulty: "intermediate",
    duration_minutes: 240,
    sort_order: 22,
    illustration_url: "/assets/learn/bucket-hat.jpg",
    is_published: true,
  },
  {
    ...
    category: "Pattern Kit",
    description: "Set of six textured hexagon cotton coasters with bobble centers.",
    content: "180 yds cotton yarn, 4.0 mm hook. Bobble hexagons with crab-stitch border.",
    difficulty: "beginner",
    duration_minutes: 120,
    sort_order: 23,
    illustration_url: "/assets/learn/hexagon-coasters.jpg",
    is_published: true,
  },
  {
    ...
    category: "Pattern Kit",
    description: "Boho handmade granny square pullover hoodie in size small with hood and drawstring.",
    content: "2,000–2,400 yds worsted yarn, 5.0 mm hook. 64 granny squares joined into body, sleeves, hood, and ribbing.",
    difficulty: "intermediate",
    duration_minutes: 2400,
    sort_order: 24,
    illustration_url: "/assets/learn/womens-granny-square-hoodie.png",
    is_published: true,
  },
];
