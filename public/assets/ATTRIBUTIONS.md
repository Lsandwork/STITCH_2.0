...
All project, lesson, yarn, and scan photos are real photographs sourced from
Creative Commons–licensed collections (Flickr, Wikimedia Commons, Openverse).
...
| `projects/color-studio.jpg` | Wikimedia — Qiviut yarn skein | CC BY-SA |

## Lessons (technique-specific)

| File | Source | License |
|------|--------|---------|
| `lessons/magic-ring.jpg` | Flickr — Small Spring Flower Crochet Part 1 (magic ring steps) | CC BY |
| `lessons/single-crochet.jpg` | Wikimedia — Single crochet swatch | CC BY-SA |
| `lessons/increasing.jpg` | Flickr — Granny square close up (corner increases) | CC BY |
| `lessons/decreasing.jpg` | Flickr — Seahorse Head WIP #2 (shaping/decrease) | CC BY |
| `lessons/working-in-round.jpg` | Flickr — Amigurumi Penguin body WIP | CC BY |
